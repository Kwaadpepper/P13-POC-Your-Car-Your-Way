...
public sealed interface SendMessage {
  ...
  sealed interface Output extends UseCaseOutput {
    record Sent() implements Output {}
  }

  final class Handler implements UseCaseHandler<Message, Output>, SendMessage {
    ...
    @Override
    public Output handle(Message message) {
